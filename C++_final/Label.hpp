...
namespace Engine {
	...
	public:
		...
		explicit Label(std::string  text, const std::string& font, int fontSize, float x, float y, unsigned char r = 0, unsigned char g = 0, unsigned char b = 0, unsigned char a = 255, float anchorX = 0, float anchorY = 0);
		/// <summary>
		...
		void ChangeColor(char r, char g, char b, char a);
	};
}
